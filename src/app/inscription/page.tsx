    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl border border-black/5 bg-white p-8 shadow-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-heading">Inscription</h1>
          <p className="mt-1 text-sm text-ink/60">Créez votre compte visiteur</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-heading">Nom</label>
            <input
              type="text"
              value={name}
